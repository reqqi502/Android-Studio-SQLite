...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (stringName.length() <=0 || stringEmail.length() <=0){
                    ...
                    MarathonModelClass marathonModelClass = new MarathonModelClass(stringName,stringEmail);
                    databaseHelperClass.addEmployee(marathonModelClass);
                    Toast.makeText(MainActivity.this, "Add person Successfully", Toast.LENGTH_SHORT).show();
                    finish();
        ...
        button_view.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this, ViewMarathoneActivity.class);
